    ...
    <header className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${scrolled ? 'bg-white/80 backdrop-blur-md shadow-sm py-4' : 'bg-transparent py-6'}`}>
      <div className="container mx-auto px-6 max-w-7xl flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-8 bg-black/5 px-8 py-3 rounded-full backdrop-blur-sm border border-white/40">
          <Link to="/" className="font-['Raleway'] font-bold text-gray-900 bg-white/60 px-5 py-1.5 rounded-lg shadow-sm">Home</Link>
          <Link to="/#about" className="font-['Raleway'] font-semibold text-gray-700 hover:text-black transition">About us</Link>
          <Link to="/#agenda" className="font-['Raleway'] font-semibold text-gray-700 hover:text-black transition">Agenda</Link>
          <Link to="/#faq" className="font-['Raleway'] font-semibold text-gray-700 hover:text-black transition">FAQ</Link>
